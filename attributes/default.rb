...
# General settings
default[:apache2][:server_admin] = 'root@localhost'
...
default[:apache2][:ssl][:DocumentRoot] = '/var/www/html'
default[:apache2][:ssl][:ServerName] = 'localhost'
default[:apache2][:ssl][:ServerAlias] = [ 'localhost.localdomain' ]
default[:apache2][:ssl][:SSLCertificateFile] = "/etc/pki/tls/certs/server.crt"
default[:apache2][:ssl][:SSLCertificateKeyFile] = "/etc/pki/tls/private/server.key"
default[:apache2][:ssl][:SSLCertificateChainFile] = "/etc/pki/tls/certs/cabundle.crt"
